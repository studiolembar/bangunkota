...
export function Contact(){
    ...
    return (
      <section className="px-5 lg:px-0 font-poppins mb-20">
        <h1 className="text-4xl mb-3 font-medium">Contact Us</h1>
        <div className="flex flex-col lg:flex-row gap-10 justify-center mt-20">
          <div className="w-full lg:w-5/12 border border-green rounded-lg p-10">
            ...
            <iframe src={map} className="mt-5 w-full" width="420" height="200" style={{border:0}} allowFullScreen={false} loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
          </div>
          <div className="w-full lg:w-5/12 border border-green rounded-lg p-10">
            <h1 className="text-center text-3xl font-medium mb-5">Contact us</h1>
            <div>
            ...
            <textarea className="textarea textarea-bordered textarea-lg h-36 w-full my-2" placeholder="Message"></textarea>
