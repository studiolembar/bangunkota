    ...
    return (
      <div
        className={`font-poppins ${
          isScrolled && "sticky top-0 z-10 shadow-lg backdrop-blur-lg"
        }`}
      >
        <div className="navbar lg:px-5 lg:container lg:mx-auto">
          ...
          <div className="navbar-center hidden lg:flex">
            <ul className="menu menu-horizontal px-1">
              <li>
                <Link
                  href={"/"}
                  className="hover:bg-base-100 hover:text-green text-lg"
                >
                  Home
                </Link>
              </li>
              ...
              <li className="dropdown">
                <label
                  tabIndex={0}
                  className="lg:flex hover:bg-base-100 hover:text-green text-lg"
                >
                  Community
                  <Image
